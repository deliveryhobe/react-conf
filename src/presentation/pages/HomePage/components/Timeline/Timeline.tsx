...
function Timeline() {
  return (
    <div className="container my-14">
      ...
      <div className="">
        <TimelineContent isComplete={true} />
        <TimelineContent isRight={true} />
        <TimelineContent isLast={true} />
      </div>
    </div>
  );
}
      ...
      {!isRight ? (
        ...
        >
          ...
          <div className="absolute left-0 top-0 sm:left-1/2">
            {/* <div className="h-full w-0.5 bg-gray-light absolute left-6 sm:left-1/2 -z-10 top-14"></div> */}
            <div
              className={cn(
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="none"
                className={cn(isComplete ? "fill-light" : "fill-secondary")}
              >
        ...
        >
          ...
          <div className="w-full flex justify-end sm:justify-start sm:pl-28">
            <div className="p-4 rounded-lg bg-light border-t-4 border-gray-light flex gap-4 max-w-[480px] shadow-[5px_0px_10px_0px_#00000024]">
              <div className="flex gap-4">
                <div className="h-4 w-4 rounded-full bg-secondary flex items-center justify-center">
                  <div className="w-1.5 h-1.5 rounded-full bg-white"></div>
